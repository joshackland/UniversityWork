...
( location_id    SMALLINT NOT NULL IDENTITY CONSTRAINT loc_pk PRIMARY KEY,
  street_address VARCHAR(50) NOT NULL,
  postal_code    VARCHAR(15) NOT NULL,
  city			 VARCHAR(30) NOT NULL,
  state_province VARCHAR(25) NOT NULL,
  country_id     CHAR(2) NOT NULL CONSTRAINT loc_cntry_fk FOREIGN KEY REFERENCES country(country_id)
);
